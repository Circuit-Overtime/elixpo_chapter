  ...
  return (
    <span
      ...
      style={{
        ...
        background: muted ? 'var(--bg-elevated)' : `color-mix(in srgb, ${color} 14%, var(--bg-surface))`,
        border: `1px solid ${muted ? 'var(--border-default)' : `color-mix(in srgb, ${color} 38%, var(--border-default))`}`,
      }}
      aria-hidden="true"
    >
