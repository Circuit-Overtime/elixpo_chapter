 ...
 *
 * Mirrors accounts.elixpo's d1-client so the two services behave identically.
 */

import type { D1Database } from "@cloudflare/workers-types";

let cachedDb: D1Database | null = null;
let cachedDbType: "cloudflare" | "api" | null = null;
...
function createRestD1Client(
    ...
    return {
        ...
        batch: async (statements: any[]) => {
            // REST API has no transactional batch; run sequentially.
            const out: any[] = [];
