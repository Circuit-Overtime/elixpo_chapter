...
export const CREATOR_BADGES = Object.freeze([
  ...
  badge('ten-stories', 'Ten Stories', 'Publish ten qualifying stories.', 'Writing', 'Moderate', 'publishedStories', 10, 'documents-outline'),
  badge('prolific-creator', 'Prolific Creator', 'Publish fifty qualifying stories.', 'Writing', 'Hard', 'publishedStories', 50, 'library-outline'),
  badge('deep-diver', 'Deep Diver', 'Publish five long-form stories that readers engage with deeply.', 'Writing', 'Hard', 'deepDiveStories', 5, 'water-outline'),
