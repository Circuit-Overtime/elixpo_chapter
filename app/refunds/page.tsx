...
export default function RefundsPage() {
    return (
        <LegalShell title="Refund & Cancellation Policy" updated="June 17, 2026">
            <p>
            ...
            <ul>
                <li>
                    ...
                    refunded. Contact us within <strong>7 days</strong> with your
                    payment reference.
                </li>
                <li>
                ...
                <li>
                    ...
                    generally non-refundable, since access remains active for the
                    full paid period after cancellation.
                </li>
            </ul>
            <p>
                Approved refunds are returned to the original payment method,
                processed through our payment provider (Razorpay), and typically
                settle within <strong>5–7 business days</strong> depending on your
                bank.
            </p>

            <h2>How to request a refund</h2>
            <p>
                Email <a href="mailto:hello@elixpo.com">hello@elixpo.com</a> from
                your account email with your payment/transaction reference and a
                short description. We respond within 2 business days.
            </p>

            <h2>Chargebacks & disputes</h2>
            <p>
                If you believe a charge is incorrect, please contact us first — we
                can resolve most issues faster than a bank dispute. Chargebacks
                are handled through the originating provider.
            </p>

            <h2>Contact</h2>
            <p>
                Questions about this policy? Email{" "}
                <a href="mailto:hello@elixpo.com">hello@elixpo.com</a> or visit our{" "}
